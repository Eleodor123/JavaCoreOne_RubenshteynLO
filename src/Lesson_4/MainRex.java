...
public class MainRex {
    public static void main(String[] args) {
        System.out.println("mQPM0W                 " + " = " + find("mQPM0W")); //6 символов
        System.out.println("}p%Uy~                 " + " = " + find("}p%Uy~")); //6 символов
        ...
        System.out.println("t}pK3cz1cT15jxMnmc~13aC" + " = " + find("t}pK3cz1cT15jxMnmc~13aC")); //23 символов
        System.out.println("C7w}J}OCJJ$8iwQLP}5k9*d" + " = " + find("C7w}J}OCJJ$8iwQLP}5k9*d")); //23 символов
